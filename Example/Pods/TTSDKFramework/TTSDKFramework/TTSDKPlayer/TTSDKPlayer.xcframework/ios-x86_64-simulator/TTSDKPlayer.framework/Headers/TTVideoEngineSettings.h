...
FOUNDATION_EXPORT const NSNotificationName kTTVideoEngineSettingsUpdateNotification;
FOUNDATION_EXPORT NSString *const kTTVideoEngineSettingsInfoWhat;

typedef NS_ENUM(NSInteger,TTVideoEngineSettingsUpdateWhat) {
    TTVideoEngineSettingsUpdateWhatIsBizPortrait = 1,
};
