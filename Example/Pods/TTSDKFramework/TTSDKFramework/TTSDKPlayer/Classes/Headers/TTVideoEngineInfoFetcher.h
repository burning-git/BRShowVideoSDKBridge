...
typedef TTVideoEngineModel *_Nullable
(^TTVideoEngineInfoFetcherCustomParseDataBlcok)(NSDictionary *_Nullable, NSError * _Nullable);
...
@property (nonatomic, assign) TTVideoEngineVideoModelPriority videoModelPriority;
...
@property (nonatomic, copy) TTVideoEngineInfoFetcherCustomParseDataBlcok customParseDataBlock;
