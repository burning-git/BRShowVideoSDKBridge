...
typedef NS_ENUM(NSUInteger, TTVideoEngineImageRotationType) {
    ...
    TTVideoEngineImageRotationType90   = 90,//clockwise
    TTVideoEngineImageRotationType180  = 180,//clockwise
    TTVideoEngineImageRotationType270  = 270,//clockwise
};
