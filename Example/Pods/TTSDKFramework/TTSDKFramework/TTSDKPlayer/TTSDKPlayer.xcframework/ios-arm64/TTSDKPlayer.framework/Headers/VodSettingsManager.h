...
//  VCVodSettings
//
//  Created by huangqing.yangtze on 2021/5/23.
//
...
FOUNDATION_EXPORT NSString *VodSettingsModuleString(NSInteger module);
...
typedef NS_ENUM(NSInteger,VodSettingsModule) {
    ...
    VodSettingsModuleBizPortrait = 5,
};
...
@property (nonatomic, assign) NSInteger maxFetchTimes;
...
- (nullable NSArray *)getUploadArray:(NSString *)key dValue:(nullable NSArray *)dValue;
...
- (nullable NSArray *)getArray:(NSInteger) module key:(NSString *)key dValue:(nullable NSArray *)dValue;
