...
@property(nonatomic, assign) NSInteger corePoolSizeUpperLimit;  //核心队列最大大小，默认为2
...
- (void)livePlayerStateChange:(NSNotification *)notification;
- (void)livePlayerViewTreeInfo:(NSNotification *)notification;
- (nullable NSArray<NSDictionary*>*)getExistingEnginesInfos;  //tag,subTag,playbackState,hasLoadingResources
- (nullable NSDictionary *)getEngineInfoWithVID:(NSString *)VID;
@end
...
@property (nonatomic, assign) NSUInteger engineHash;
@property (nonatomic, copy, nullable) NSString *tag;
@property (nonatomic, copy, nullable) NSString *subtag;
@property (nonatomic, copy, nullable) NSString *viewTreeInfo;
