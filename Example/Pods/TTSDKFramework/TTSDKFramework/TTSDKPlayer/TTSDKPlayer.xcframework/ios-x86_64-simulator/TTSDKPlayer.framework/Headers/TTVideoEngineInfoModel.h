...
static const NSInteger VALUE_VIDEO_HEAD_SIZE = 19;
...
static const NSInteger VALUE_AI_BARRAGE_URL      = 36;
...
static const NSInteger VALUE_VOLUME_LU_RANGE     = 230;
static const NSInteger VALUE_VOLUME_LU_START     = 231;
static const NSInteger VALUE_VOLUME_LU_END       = 232;
static const NSInteger VALUE_VOLUME_MAX_MOM      = 233;
static const NSInteger VALUE_VOLUME_MAX_SHOTERM  = 234;
static const NSInteger VALUE_VOLUME_VER          = 235;


static const NSInteger VALUE_MASK_VERSION        = 240;
static const NSInteger VALUE_MASK_URL            = 241;
static const NSInteger VALUE_MASK_FILE_ID        = 242;
static const NSInteger VALUE_MASK_FILE_HASH      = 243;
static const NSInteger VALUE_MASK_FILE_SIZE      = 244;
static const NSInteger VALUE_MASK_UPDATED_AT     = 245;
static const NSInteger VALUE_MASK_BITRATE        = 246;
static const NSInteger VALUE_MASK_HEAD_LEN       = 247;

static const NSInteger VALUE_FILE_ID             = 300;
static const NSInteger VALUE_P2P_VERIFYURL       = 301;
static const NSInteger VALUE_VIDEO_INFO_ID       = 302;

static const NSInteger VALUE_BUSINESS_ID        = 303;

FOUNDATION_EXPORT const NSInteger VALUE_MULTI_BITRATE_REFACTOR;
FOUNDATION_EXPORT const NSInteger VALUE_VOLUME_INFO_JSON;
FOUNDATION_EXPORT const NSInteger VALUE_FIRST_MOOF_RANGE;
...
@property (nonatomic, nullable, copy) NSString   *aiBarrageUrl;
...
@property (nonatomic, nullable, copy) NSString   *bashFirstMoofRange;
...
@property (nonatomic, nullable, copy) NSString *dubVersion;
@property (nonatomic, assign) NSInteger infoId;
/// only: TTVideoEnginePlayAPIVersion4
@property (nullable, nonatomic, copy, readonly) NSString *hlsproxyExpireTimeQuery;
/// only: TTVideoEnginePlayAPIVersion4
@property (nonatomic, copy, readonly) NSArray<NSString *> *urlExpireTimes;
...
- (void)parseMediaDict:(NSDictionary *)mediaDict;

- (instancetype (^)(NSNumber *))setVHeight;
- (instancetype (^)(NSNumber *))setVWidth;
- (instancetype (^)(NSNumber *))setSize;
- (instancetype (^)(NSInteger))setBitrate;
- (instancetype (^)(NSNumber *))setUrlExpire;
- (instancetype (^)(NSString *))setVType;
- (instancetype (^)(NSString *))setCodecType;
- (instancetype (^)(NSString *))setFileHash;
- (instancetype (^)(NSString *))setFileId;
- (instancetype (^)(NSString *))setQualityDesc;
- (instancetype (^)(NSString *))setDefinition;
- (instancetype (^)(NSString *))setCheckInfo;
- (instancetype (^)(NSString *))setMediaType;
- (instancetype (^)(NSString *))setMainURLStr;
- (instancetype (^)(NSString *))setBackupURL1;
- (instancetype (^)(NSString *))setBackupURL2;
- (instancetype (^)(NSString *))setBackupURL3;
@end
...
@property (nonatomic, nullable, copy) NSArray<TTVideoEngineURLInfo *> *dubbedAudioInfo;
@property (nonatomic, nullable, copy) NSArray<TTVideoEngineURLInfo *> *originalAudioInfo;
@property (nonatomic, assign) NSInteger defaultAudioInfoId;
...
- (nullable TTVideoEngineURLInfo *)videoForResolutionType:(TTVideoEngineResolutionType)type
                                           ...
                                           otherCondition:(nullable NSDictionary *)params;

- (nullable TTVideoEngineURLInfo *)videoForBitrate:(NSInteger)bitrate
                                                mediaType:(nullable NSString *)mediaType;

/// mediaType = @"video" && params = nil.
- (nullable TTVideoEngineURLInfo *)videoForResolutionType:(TTVideoEngineResolutionType)type;

- (nullable NSArray<NSNumber *> *)getSupportedMediaInfoIds:(NSString *)mediaType;

- (nullable TTVideoEngineURLInfo *)getUrlInfoWithMediaInfoId:(NSInteger)infoId;

- (nullable NSArray<TTVideoEngineURLInfo *> *)getSupportedTTSAudioInfo;

- (nullable NSArray<TTVideoEngineURLInfo *> *)getOriginalAudioInfo;
...
@property (nonatomic, assign) NSInteger videoStyle;
@property (nonatomic, assign) NSInteger dimension;
@property (nonatomic, assign) NSInteger projectionModel;
...
@property (nonatomic, nullable, strong) TTVideoEngineVideoStyle   *videoStyle;

@property (nonatomic, nullable, strong) NSMutableArray<TTVideoEngineThumbInfo *> *bigThumbs;
@property (nonatomic, nullable, strong) TTVideoEngineMaskInfo     *maskInfo;
...
@property (nonatomic, nullable, copy) NSString       *memString;
@property (nonatomic, assign) NSInteger               popularityLevel;
@property (nonatomic, assign) BOOL                    enableAdaptive;
@property (nonatomic, assign) BOOL                    hasEmbeddedSubtitle;
@property (nonatomic, nullable, copy) NSArray        *subtitleInfos;
@property (nonatomic, nullable, copy) NSString       *pallasVidLabels;
@property (nonatomic, nullable, copy) NSString *bId; // business Id.
@property (nonatomic, assign) BOOL                    isMbRefactor;
...
- (nullable NSArray *)allURLWithDefinition:(TTVideoEngineResolutionType)type
...
- (nullable TTVideoEngineURLInfo *)videoInfoForBitrate:(NSInteger)bitrate
                                             mediaType:(nullable NSString *)mediaType;

- (nullable NSArray<NSString *> *)allUrlsWithResolution:(TTVideoEngineResolutionType *)type
                                               autoMode:(BOOL)model;
...
- (instancetype (^)(NSString *))setVideoID;
- (instancetype (^)(NSString *))setBusinessID;
- (instancetype (^)(NSNumber *))setVideoDuration;
- (instancetype (^)(CGFloat))setLoudness;
- (instancetype (^)(CGFloat))setPeak;
- (instancetype (^)(BOOL))setAdaptive;
- (instancetype (^)(TTVideoEngineURLInfo *))addVideoInfo;
