...
typedef NS_ENUM(NSInteger, TTVideoEngineError) {
    // MDLRetry Error
    TTVideoEngineErrorMDLFetcherListenerEmpty = -10001,
    TTVideoEngineErrorFallbackApiEmpty = -10002,
    TTVideoEngineErrorFileHashInvalid = -10003,
    TTVideoEngineErrorResultExpired = -10004,
    TTVideoEngineErrorFetchStatusException = -10005,
    TTVideoEngineErrorUrlFetchEmpty = -10006,
    ...
    TTVideoEngineErrorFetchCkc = -9975, // Fps获取ckc失败
    ...
    // LICENSE
    TTVideoEngineLicenseFailed = -30001,
    ...
    TTVideoEngineErrorExistedTask = -9943,
    
    /// preload
    TTVideoEnginePreloadErrCodeParameter =  -100000,
    TTVideoEnginePreloadErrCodeSameTask =  -100001,
    
    TTVideoEngineErrorHttpForbidden = -499897, // http 403
    
    /// tob
    TTVideoEngineGetPlayInfoBadGateway = 502, // http 502
    TTVideoEngineGetPlayInfoHostNotFound = -1003 // hostname could not be found
};
...
typedef NS_ENUM(NSUInteger, TTVideoEngineMDLDnsType) {
    TTVideoEngineMDLDnsTypeUnknown   = 0,
    TTVideoEngineMDLDnsTypeLocal     = 1,
    TTVideoEngineMDLDnsTypeAli       = 2,  // deprecated
    TTVideoEngineMDLDnsTypeTT        = 3,
    TTVideoEngineMDLDnsTypeGoogle    = 4,
    TTVideoEngineMDLDnsTypeCustom    = 5,
};
...
static NSString *const kTTVideoErrorDomainMDLRetry = @"kTTVideoErrorDomainMDLRetry";
static NSString *const kTTVideoErrorDomainFairPlay = @"kTTVideoErrorDomainFairPlay";
...
FOUNDATION_EXTERN BOOL TTVideoEngineIsDrmExpireError(NSInteger code);
...
FOUNDATION_EXTERN BOOL TTVideoEngineIsTranscodeUrls(NSArray *arr);
FOUNDATION_EXTERN BOOL TTVideoEngineIsDataError(NSInteger code);
