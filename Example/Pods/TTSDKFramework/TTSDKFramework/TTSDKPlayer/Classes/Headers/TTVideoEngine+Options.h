...
typedef NS_ENUM(NSInteger, VEKKey)
{
    ...
    VEKKeyPlayerSmoothlySwitching_BOOL                     = 6, // deprecate! HLS Smooth -> VEKKeyPlayerHLSSeamlessSwitchEnable_BOOL
    /* Loop sswitch. */
    ...
    //metrics ablity
    VEKKeyMetricAbility_NSInteger = 214,
    //metrics interval
    VEKKeyMetricInterval_NSInteger = 215,
    /* Async close option. */
    VEKKeyPlayerAsyncClose_BOOL = 216,
    //enable mach time
    VEKKeyEnableUseMachTime_BOOL = 217,
    //value to disable engine dns
    VEKKeyDisableEngineDNS = 218,
    // play-load config
    VEKKeyStrategyPlayLoadConfig_NSString = 219,
    // play-range config
    VEKKeyStrategyPlayRangeConfig_NSString = 220,
    // play-buffer config
    VEKKeyStrategyPlayBufferConfig_NSString = 221,
    //video duration
    VEKKeyVideoDuration_CGFloat = 222,
    // sr extra mode
    VEKKeyPlayerSRExtraMode_NSInteger = 223,
    // disable audio Interruption by single engine instance
    VEKKeyIsIgnoreAudioInterruption_BOOL = 224,
    // render
    VEKKeyIsCustomizedVideoRenderingFrameRate = 235,
    VEKKeyIsEnableVsyncHelper = 236,
    VEKKeyIsVideoRenderStallThreshold_NSInteger = 237,
    VEKKeyBufferingStartIDLTime_NSInteger = 238,
    ...
    ///Audio Effect
    /**AE Climiter release time**/
    VEKKeyPlayerAudioEffectReleaseTime_CGFloat = 300,
    /**AE Climiter look ahead time**/
    VEKKeyPlayerAudioEffectLookAheadTime_CGFloat = 301,
    /**AE loudness range**/
    VEKKeyPlayerAudioEffectLuRang_CGFloat = 302,
    /**AE loudness range start**/
    VEKKeyPlayerAudioEffectLuStart_CGFloat = 303,
    /**AE loudness range end**/
    VEKKeyPlayerAudioEffectLuEnd_CGFloat = 304,
    /**AE loudness MaxMom**/
    VEKKeyPlayerAudioEffectMaxMomLu_CGFloat = 305,
    /**AE loudness Shorterm**/
    VEKKeyPlayerAudioEffectShortermLu_CGFloat = 306,
    /**AE Volum Info Version**/
    VEKKeyPlayerAudioEffectVolumInfoVer_NSInteger = 307,
    /**AE device playback ability**/
    VEKKeyPlayerAudioEffectDevicePlayAbility_NSInteger = 308,
    /**AE json config**/
    VEKKeyPlayerAudioEffectJsonConfig_NSString = 309,
    /**AE volume info json string**/
    VEKKeyPlayerAudioEffectVolumeInfoJson_NSString = 310,
    VEKKeyPlayerAudioEffectGraphConfig_NSString = 311,
    /// Model
    VEKKeyModel                                    = 1 << 9,
    ...
    /** Set the network reporting sampling interval ms */
    VEKKeyPlayerNetLevelSampleInterval_NSInteger = 519,
    /** Set the maximum number of samples reported by the network */
    VEKKeyPlayerNetLevelMaxSampleCount_NSInteger = 520,
    /** Set the minimum amount of data reported by the network */
    VEKKeyPlayerNetLevelMinDatasize_NSInteger = 521,
    /** Set network var parameters */
    VEKKeyPlayerNetworkQualityVarString_NSString = 522,
    /** Set the mdl speed measurement interval */
    VEKKeyPlayerNetSpeedUpdateInterval_NSInteger = 523,
    /// DNS
    VEKKeyDNS                                      = 1 << 10,
    ...
    VEKKeyIsVoiceVolumeFadeMode_ENUM            = 1032,
    VEKKeyIsFirstNativeMdlUse_NSInteger         = 1033,
    VEKKeyPlayerVideoRotation_NSInteger         = 1040,
    VEKKeySpecialFuncitonType_NSInteger         = 1041,
    ...
    VEKKeyPreloadEnableCheckByPlay_BOOL            = (1 << 11) + 10,
    ...
    VEKKeyPlayerEncryptionEnabled_BOOL               = (1 << 14) + (1 << 13) + 1,
    /* enable hls playing */
    VEKKeyPlayerHLSEnabled_BOOL                      = (1 << 14) + (1 << 13) + 2,
    /* enable vtb drop rasl */
    VEKeyIsEnableVtbDropRASL                         = (1 << 14) + (1 << 13) + 3,
    /* enable av sync between tow interrupt videos */
    VEKKeyIsAVSyncInterruptEanbled_BOOL              = (1 << 14) + (1 << 13) + 4,
    /** ignore video toolbox bad data err */
    VEKKeyIsEnableVtbIgnoreBadDataErr_BOOL           = (1 << 14) + (1 << 13) + 5,
    /* Trace to the source of video model. The Value type is TTVideoEngineVideoModelPriority */
    VEKKeyPlayerVideoModelPriority_ENUM              = (1 << 14) + (1 << 13) + 6,
    ...
    /// enable master m3u8 optimize
    VEKKeyMasterm3u8OptimizeEnable_BOOL              = (1 << 14) + (1 << 13) + 9,
    /// enable HLS cachemodule preload the first ts.
    VEKKeyHLSProxyPreloadFirstTsEnable_BOOL          = (1 << 14) + (1 << 13) + 10,
    ///
    VEKKeyHLSProxyPreloadAllTsEnable_BOOL            = (1 << 14) + (1 << 13) + 11,
    ///
    ///
    ///tob end
    ///
    ...
    /** enable bvc1 opt*/
    VEKKeyPlayerEnableCPPh265CodecOpt_BOOL   = 40005,
    ...
    VEKKeyPlayerEnableCPPBYTEVC2CodecOpt_BOOL   = 40073,
    VEKKeyIsAudioPtsMSCorrectionExtension       = 40074,
    VEKKeyIsVC2WppMode                          = 40075,
    VEKKeyIsBYTEVC2LowLatency                   = 40076,
    VEKKeyIsEnableSeekBuffering                 = 40084,
    VEKKeyIsVC2ThreadNum                        = 40085,
    VEKKeyIsEnableFindAmbientForHDR             = 40087,
    VEKKeyIsEnableYUV420PVideoProcessor     = 40088,
    VEKKeyIsEnableOptimizeRadioMode_BOOL        = 40089,
    VEKKeyIsMovingIOSViewOpToMainThread_BOOL    = 40090,
    VEKKeyIsFixingStartingPlayIssue_BOOL        = 40091,
    VEKKeyIsEnableDynamicGaussianBlur           = 40092,
    VEKKeyIsAllowAllExtensions                  = 40095,
    //SetIntCfg_MinGuard_SI = 42000
    VEKKeyIsEnableCorrectRealClock_BOOL         = 42004,
    VEKKeyIsEnableOptimizeDashSeek_BOOL         = 42005,
    VEKKeyIsEnableAccurateSleepForDummyVoice_BOOL = 42007,
    VEKKeyIsEnableBMFAsyncInit                  = 42008,
    VEKKeyIsForceSRInLowFrameRateVideo          = 42009,
    VEKKeyIsOptimizeStartTimePrerender_BOOL     = 42010,
    VEKKeyIsEnableSoftSRReleaseTmpBuffer        = 42013,
    VEKKeyEnableMultiAudioTrack_BOOL            = 42017,
    VEKKeyIsEnableVoiceVolumeFade_BOOL            = 42018,
    VEKKeyIsVoiceFadeEmbellishmentTime_NSInteger  = 42019,
    VEKKeyIsEnableGlobalMuteFadeIn_BOOL           = 42020,
    VEKKeyIsEnableAudioTypeChangeFadeIn_BOOL      = 42021,
    VEKKeyIsExtVoiceOutputFormat_ENUM             = 42026,
    VEKKeyOutletThreadOptimize_NSInteger          = 42027,
    VEKKeyIsEnableEnsureSRGetFirstFrame           = 42034,
    VEKKeyIsEnableSampleBufferWriteInMainThread   = 42041,
    VEKKeyIsEnableVPRGBToYUVOnceHandle            = 42047,
    VEKKeyIsEnableDisplayP3NV12                   = 42052,
    VEKKeyIsFixDashSeekStuck                      = 42054,
    VEKKeyIsOptSoftStride                            = 42059,
    VEKKeyIsEnableVodVideoRenderStall             = 42064,
    VEKKyeIsMaxSegRetry                           = 42077,
    VEKKeyIsEnableSegError                        = 42078,
    VEKKeyIsSampleBufferLayerFlushInSyncMainThread = 42074,
    VEKKeyIsIgnoreWaveLength_BOOL                 = 42084,
    VEKKeyIsEnableFastSeek_BOOL                   = 42088,
    VEKKeyIsEnableSeekLastFrame                   = 42089,
    VEKKeyIsSeekEndFFMPEGThresholdSI              = 42090,
    VEKKeyIsEnableMetalRenderHDR       = 42091,
    VEKKeyIsVideoAbnormalInterval_NSInteger       = 42302,
    VEKKeyIsVideoAbnormalStrategy_NSInteger       = 42303,
    VEKKeyIsVideoProcessStatistics_NSInteger      = 42310,
    VEKKeyDirIntMaxGuard_NSInteger              = 49999,
    // dynamic set / player core (VEKKeyDirIntMinGuard_NSInteger + TTPlayerPreDynamicDiv + x)
    VEKKeyIsEnableMetalViewDoubleBuffering = 50057,
    VEKKeyIsDynamicGaussianBlurResetViewSize = 50094,
    VEKKeyIsPreciseCacheForDash_NSInterger = 50095,
    VEKKeyPlayerCoreDynamicLoadMaxGuard_NSInteger = 59999,
...
typedef NS_ENUM(NSInteger, VEKGSKey)
{
    ...
    VEGSKeyTlsLog_BOOL                          = 16,
    VEGSKeyLooperV2_INT                         = 17,
    VEGSKeyGlobalSendAudioDevice_BOOL           = 18,
    VEGSKeyGlobalTestDeviceAfterPause_BOOL      = 19,
    VEGSKeyEnableVC2ThreadPriority   = 20,
    VEGSKeyVC2ThreadPriorityValue    = 21,
    VEGSKeyIgnoreGlActive            = 22,
    VEGSKeyRenderAfterResignActive   = 23,
    VEGSKeyEnableEncryptBuryData_BOOL           = 24,
    VEGSKeyEnableReportContentData_BOOL = 25,
    // warning: 0-1000 is for TTPlayer
    ...
    VEGSKeyEnableGlobalHookVoice              = 5005,
    VEGSKeyEnableLiveCrosstalkCheck_BOOL      = 5006,
    //开启监听旁白模式
    VEGSKeyEnableObserveVoiceOver_BOOL = 5007,
    //旁白模式开启后播放器音量缩减比例，范围在0~1
    VEGSKeyVolumeRatioWhenVoiceOverIsRunning_CGFloat = 5008,
    VEGSKeyForceMetalRender_NSInteger         = 5009, // force enabled, since 20230420
    //创建gTTVideoEngineGroup
    VEGSKeyEnableTTVideoEngineDispatchGroup_BOOL = 5010,
    //Trace Host
    VEGSKeyEnableTTVideoEnginTraceHost_NSString = 5011,
    VEGSKeyEnableVideoDataOptimize_BOOL = 5012,

    /*---- tob (20000 + x) ----*/
    /* Set VideoModel disk cache max count */
    VEGSKeyPlayerVideoModelMaxCache_NSInteger = 20001,
    /* Set this option means MDL will force is hls source(AVMDLSpec), pre-condition is hls enable */
    VEGSKeyPlayerForceLsHLSSource_BOOL = 20002,
    ...
    VEGSKeyAlgoOptionUseContentLength = 50039,
    VEGSKeyAlgoGlobalOptionEnd = 60000,      /// TTVideoEngineStrategyAlgoGlobalOptionEnd
    
    VEGSKeyEnableConfigCenter = 90000,
    VEGSKeyConfigCenterLogCount_NSInteger = 90001,
    VEGSKeyEnablePcdnAuto = 90002,
};
...
typedef NS_ENUM(NSInteger,VEKFilterType) {
    ...
    VEKFilterTypeBMP,
    VEKFilterTypeSDR2HDR,
    VEKFilterTypeDynamicGaussianBlur,
    VEKFilterTypeBMFVideoSharpLut,
    VEKFilterTypeBmfHDRLightnessNormaliza,
    VEKFilterTypeMax,
};

typedef NS_ENUM(NSInteger, VEKProcessorOptions) {
    VEKProcessorInitEffect = 0,
    VEKProcessorIsFilterUsing = 1,
    VEKProcessorUseEffect = 2,
    VEKProcessorUseLens = 3,
    VEKProcessorUpdateImage = 4,
    VEKProcessorFilterStrength = 5,
    VEKProcessorWidth = 6,
    VEKProcessorHeight = 7,
    VEKprocessorYUVtoRGBMatrix = 8,
    VEKProcessorFilterCrop = 9,
    VEKProcessorVROutputTextureSize = 10,
    VEKProcessorVRConfiguration = 11,
    VEKProcessorVRRecenter = 12,
    VEKProcessorFilterAlpha = 13,
    VEKProcessorFilterBMP = 14,
    VEKProcessorPerEffectAverageTime = 15,
    VEKProcessorEffectChainAverageTime = 16,
    VEKProcessorVersion = 17,
    VEKProcessorPerEffectErrorCode = 18,
    VEKProcessorPerEffectErrorMsg = 19,
    VEKProcessorSRAverageCostTime = 20,
    VEKProcessorSRSuccessRate = 21,
    VEKProcessorFilterBMFRoiSR = 22,
    VEKProcessorOutputFormat = 23,
    VEKProcessorIsRenderType = 24,
    VEKProcessorDynamicGaussConfig = 25,
    VEKProcessorDownLoadResource = 31,
    VEKProcessorFilterUpdateBmfSRSharpLevel = 34,
};

typedef NS_ENUM(NSInteger, VEKPlayerForSpecialFunctionType) {
    VEKPlayerForSpecialFunctionTypeUnknow = 0,
    VEKPlayerForSpecialFunctionTypeAlpha3D = 1,
};

typedef NS_ENUM(NSInteger ,VEKPlayerExtraViewType) {
    VEKPlayerExtraViewUnknow = 0,
    VEKPlayerExtraViewAlpha3D = 1
};
...
static NSString *const VEKProcessorDynamicGussianBlurGradientLength = @"pGradientLength";
static NSString *const VEKProcessorDynamicGussianBlurOffsetx = @"pDGBOffsetx";
static NSString *const VEKProcessorDynamicGussianBlurOffsety = @"pDGBOffsety";

@class TTAVTraitObject;
typedef NS_ENUM(NSInteger, TTAVTraitType);

extern NSString *const VEKProcessorFilterBmfBnWeightWidth;
extern NSString *const VEKProcessorFilterBmfBnWeightHeight;
extern NSString *const VEKProcessorFilterBmfBnWeightDepth;
extern NSString *const VEKProcessorFilterBmfBnThresh;
extern NSString *const VEKProcessorFilterBmfBnSteps;
extern NSString *const VEKProcessorFilterBmfBnStepsCnt;
extern NSString *const VEKProcessorFilterBmfBnStrengths;
extern NSString *const VEKProcessorFilterBmfBnStrengthCnt;
extern NSString *const VEKDownloadProcessorModelVersion;
extern NSString *const VEKDownloadProcessorCacheDir;
extern NSString *const VEKProcessorDownloadHost;
extern NSString *const VEKProcessorStatus;
extern NSString *const VEKProcessorDownloadOC;
extern NSString *const VEKProcessorAlgorithmName;
extern NSString *const VEKProcessorHttpClient;
extern NSString *const VEKProcessorFilterModelPath;
extern NSString *const VEKProcessorDyGauBlurTexMaxLength;
extern NSString *const VEKProcessorDyGauBlurControlNum;
extern NSString *const VEKProcessorHdrLutBitmapStr;
extern NSString *const VEKProcessorBmfExtraParamterSharpLevel;
...
- (void)setTraitObjectForKey:(TTAVTraitType)key value:(TTAVTraitObject *_Nullable)traitObj;
